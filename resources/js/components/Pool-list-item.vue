    ...
    <div class="col-md-6 col-xl-4">
        ...
        <div class="card border border-2 border-gray-300 border-hover">
            ...
            <div class="card-header border-0 pt-9">
                ...
                <div class="card-title m-0">
                    <div class="symbol-group symbol-hover">
                        <!--begin::User-->
                        <div class="symbol symbol-50px symbol-circle" data-bs-toggle="tooltip" title="" data-bs-original-title="AVAX">
                            <img alt="Pic" :src="poolAsset.token_0.logo_url">
                        </div>
                        <!--begin::User-->
                        <!--begin::User-->
                        <div class="symbol symbol-50px symbol-circle" data-bs-toggle="tooltip" title="" data-bs-original-title="ETH">
                            <img alt="Pic" :src="poolAsset.token_1.logo_url">
                        </div>
                        <!--begin::User-->
                    </div>
                    <!--end::Avatar-->
                ...
                <div class="card-toolbar">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal"><span class="btn btn-light-primary btn-sm fw-bolder me-auto px-4 py-3" >Find best swap</span></a>
                </div>
                                    ...
                                    <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_modal_offer_a_deal_form">
                                        ...
                                        <div data-kt-stepper-element="content">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <!--end::Actions-->
                                                <!--begin::Illustration-->
                                                <img src="assets/media/svg/illustrations/presentation.svg" alt="" class="mx-auto w-100 mh-300px" />
                                                <!--end::Illustration-->
                                            </div>
                                        </div>
                                        <!--end::Complete-->
            ...
            <div class="card-body p-9">
                <!--begin::Name-->
                <div class="fs-3 fw-bolder text-dark">{{poolAsset.token_0.contract_ticker_symbol}} - {{poolAsset.token_1.contract_ticker_symbol}}</div>
                <!--end::Name-->
                <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">{{poolAsset.token_0.contract_name}} - {{poolAsset.token_1.contract_name}}</p>
                <!--begin::Info-->
                <div class="d-flex flex-wrap mb-5">
                    ...
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-2 mb-3">
                        <div class="fs-6 text-gray-800 fw-bolder">
                            {{poolAsset.total_liquidity_quote | currency}}</div>
                        <div class="fw-bold text-gray-400">Total Liquidity</div>
                    </div>
                    <!--end::Due-->
                    <!--begin::Budget-->
                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-2 mb-3">
                        <div class="fs-6 text-gray-800 fw-bolder">{{poolAsset.volume_24h_quote | currency}}</div>
