                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link active" href="pages/projects/project.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                                ...
                                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                    ...
                                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
                                                        ...
                                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                            ...
                                                            <div class="menu-item">
                                                                <a class="menu-link active py-3" href="pages/projects/project.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                                    <span class="menu-title">View Project</span>
                ...
                <div class="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center me-3">
                            <!--begin::Title-->
                            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">View Project</h1>
                            <!--end::Title-->
                            <!--begin::Separator-->
                            ...
                            <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex mb-4">
                                                <a href="#" class="btn btn-icon-primary btn-bg-light btn-text-primary me-3" data-bs-toggle="modal">
                                                    <span class="svg-icon svg-icon-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                ...
                                <div class="d-flex overflow-auto h-55px">
                                    ...
                                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                                        <!--begin::Nav item-->
                                        <li class="nav-item">
                                            <a class="nav-link text-active-primary me-6" href="{{route('dex', [strtolower($general_data['name'])])}}">Overview</a>
                                        </li>
                                        <!--end::Nav item-->
                                        <!--begin::Nav item-->
                                        <li class="nav-item">
                                            <a class="nav-link text-active-primary me-6 active" href="#">Pools</a>
                                        </li>
                                        <!--end::Nav item-->
                                    </ul>
                                    <!--end::Nav links-->
                                        ...
                                        <a href="pages/projects/project.html" class="card border border-2 border-gray-300 border-hover">
                                            ...
                                            <div class="card border border-2 border-gray-300 border-hover">
                                                ...
                                                <div class="card-header border-0 pt-9">
                                                    ...
                                                    <div class="card-title m-0">
                                                        <div class="symbol-group symbol-hover">
                                                            <!--begin::User-->
                                                            <div class="symbol symbol-50px symbol-circle" data-bs-toggle="tooltip" title="" :data-bs-original-title="{{$topPool['token_0']['contract_ticker_symbol']}}">
                                                                <img alt="Pic" src="{{$topPool['token_0']['logo_url']}}">
                                                            </div>
                                                            <!--begin::User-->
                                                            <!--begin::User-->
                                                            <div class="symbol symbol-50px symbol-circle" data-bs-toggle="tooltip" title="" :data-bs-original-title="{{$topPool['token_1']['contract_ticker_symbol']}}">
                                                ...
                                                <div class="card-body p-9">
                                                    <!--begin::Name-->
                                                    <div class="fs-3 fw-bolder text-dark">{{$topPool['token_0']['contract_ticker_symbol']}} - {{$topPool['token_1']['contract_ticker_symbol']}}</div>
                                                    <!--end::Name-->
                                                    <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">{{$topPool['token_0']['contract_name']}} - {{$topPool['token_1']['contract_name']}}</p>
                                                    <!--begin::Info-->
                                                    <div class="d-flex flex-wrap mb-5">
                                                        ...
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-2 mb-3">
                                                            <div class="fs-6 text-gray-800 fw-bolder">
                                                                {{new \Akaunting\Money\Money($topPool['total_liquidity_quote'], new \Akaunting\Money\Currency('USD'), true)}}</div>
                                                            <div class="fw-bold text-gray-400">Total Liquidity</div>
                                                        </div>
                                                        <!--end::Due-->
                                                        <!--begin::Budget-->
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-2 mb-3">
                                                            <div class="fs-6 text-gray-800 fw-bolder">{{new \Akaunting\Money\Money($topPool['volume_24h_quote'], new \Akaunting\Money\Currency('USD'), true)}}</div>
                                                            <div class="fw-bold text-gray-400">24h Volumes</div>
                                                        </div>
                                                        <!--end::Budget-->
                                                    </div>
                                                    <!--end::Info-->
