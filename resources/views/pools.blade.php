									...
									<span class="menu-link">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
											...
											<span class="menu-link">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    <div class="menu-item">
                                                        <a class="menu-link active" href="pages/projects/list.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														...
														<span class="menu-link py-3">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																...
																<span class="menu-link py-3">
                                                                    ...
                                                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                        <div class="menu-item">
                                                                            <a class="menu-link active py-3" href="pages/projects/list.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                                                <span class="menu-title">My Porjects</span>
                            ...
                            <div class="toolbar" id="kt_toolbar">
                                ...
                                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-3">
                                        <!--begin::Title-->
                                        <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">My Projects</h1>
                                        <!--end::Title-->
                                        <!--begin::Separator-->
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                            ...
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-dark">My Porjects</li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                ...
                                <div id="kt_content_container" class="container">
                                    ...
                                    <div class="row g-6 g-xl-9">
                                        <div class="col-lg-6 col-xxl-4">
                                            ...
                                            <div class="card h-100">
                                                ...
                                                <div class="card-body p-9">
                                                    ...
                                                    <div class="fs-4 fw-bold text-gray-400 mb-7">Current Active Pools</div>
                                                    <!--end::Heading-->
                                                    <!--begin::Wrapper-->
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
                                                            ...
                                                            <div class="d-flex fs-6 fw-bold align-items-center mb-3">
                                                                ...
                                                                <div class="ms-auto fw-bolder text-gray-700">200</div>
                                                            </div>
                                                            <!--end::Label-->
                                                            <!--begin::Label-->
                                        ...
                                        <div class="col-lg-6 col-xxl-4">
                                            ...
                                            <div class="card h-100">
                                                <div class="card-body p-9">
                                                    <div class="fs-2hx fw-bolder">$18,485,173,290.25</div>
                                                    <div class="fs-4 fw-bold text-gray-400 mb-7">Total Pools Liquidity</div>
                                                    <div class="fs-6 d-flex justify-content-between mb-4">
                                                        <div class="fw-bold">24h Volume</div>
														...
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            ...
                                                            <!--end::Svg Icon-->$235,175,570.00</div>
                                                    </div>
                                                    <div class="separator separator-dashed"></div>
                                                    <div class="fs-6 d-flex justify-content-between my-4">
                                                        <div class="fw-bold">Total Swap</div>
                                                        <div class="d-flex fw-bolder">
                                                            <!--begin::Svg Icon | path: icons/stockholm/Navigation/Down-left.svg-->
                                        ...
                                        <div class="col-lg-6 col-xxl-4">
                                            ...
                                            <div class="card h-100">
                                                <div class="card-body p-9">
                                                    <!--begin::Heading-->
                                                    <div class="fs-2hx fw-bolder">24</div>
                                                    <div class="fs-4 fw-bold text-gray-400 mb-7">Decentralized Exchange </div>
                                                    <!--end::Heading-->
                                                    <!--begin::Users group-->
                                                    <div class="symbol-group symbol-hover mb-9">
                                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                                            <img alt="Pic" src="https://cryptonaute.fr/wp-content/uploads/2021/01/uniswap-uni-logo.png" />
                                                        </div>
                                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michelle Swanston">
                                                            <img alt="Pic" src="https://miro.medium.com/max/3150/1*dG8HvEw1-PUT3xZH3_WZEw.png" />
                                                        </div>
                                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Francis Mitcham">
                                                            <img alt="Pic" src="https://seeklogo.com/images/B/balancer-bal-logo-175E391C6D-seeklogo.com.png" />
                                                        </div>
                                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Francis Mitcham">
                                                            <img alt="Pic" src="https://tokens.1inch.exchange/0x6b3595068778dd592e39a122f4f5a5cf09c90fe2.png" />
                                                        </div>
                                                    </div>
                                                    <!--end::Users group-->
                                                    <!--begin::Actions-->
                                                    <div class="d-flex">
                                                        <a href="#" class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">See All</a>
                                                    </div>
                                                    <!--end::Actions-->
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex flex-wrap flex-stack my-5">
                                        <!--begin::Heading-->
                                        <h2 class="fs-2 fw-bold my-2">Pools
                                            <span class="fs-6 text-gray-400 ms-1">by Name</span></h2>
                                        <!--end::Heading-->
                                        <!--begin::Controls-->
                                            ...
                                            <a href="pages/projects/project.html" class="card border border-2 border-gray-300 border-hover">
                                                ...
                                                <div class="card-header border-0 pt-9">
                                                    ...
                                                    <div class="card-title m-0">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-50px w-50px bg-light">
                                                            <img src="assets/media/svg/misc/tvit.svg" alt="image" class="p-3" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                    </div>
                                                    <!--end::Car Title-->
                                            ...
                                            <a href="pages/projects/project.html" class="card border border-2 border-gray-300 border-hover">
                                                ...
                                                <div class="card-header border-0 pt-9">
                                                    ...
                                                    <div class="card-title m-0">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-50px w-50px bg-light">
                                                            <img src="assets/media/svg/misc/aven.svg" alt="image" class="p-3" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                    </div>
                                                    <!--end::Car Title-->
                                            ...
                                            <a href="pages/projects/project.html" class="card border border-2 border-gray-300 border-hover">
                                                ...
                                                <div class="card-header border-0 pt-9">
                                                    ...
                                                    <div class="card-title m-0">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-50px w-50px bg-light">
                                                            <img src="assets/media/svg/misc/treva.svg" alt="image" class="p-3" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                    </div>
                                                    <!--end::Car Title-->
                                            ...
                                            <a href="pages/projects/project.html" class="card border border-2 border-gray-300 border-hover">
                                                ...
                                                <div class="card-header border-0 pt-9">
                                                    ...
                                                    <div class="card-title m-0">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-50px w-50px bg-light">
                                                            <img src="assets/media/svg/misc/kanba.svg" alt="image" class="p-3" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                    </div>
                                                    <!--end::Car Title-->
